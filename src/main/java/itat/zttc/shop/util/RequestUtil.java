...
public class RequestUtil {
	...
	public final static String PATH = RequestUtil.class
            .getResource("/").getPath();
	...
	public static void uploadFile(String fname, String fieldName,byte[] fs,HttpServletRequest req) throws FileNotFoundException, IOException {
        ...
        try {
			if(fs.length>0) {
				...
				if(b) {
					fos = new FileOutputStream(contextPath+"/img/"+fn);
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(RequestUtil.class.getResource("/").getPath());
        System.out.println(RequestUtil.class.getClassLoader().getResource("").getPath());
    }
}
